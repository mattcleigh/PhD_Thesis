...
\newglossaryentry{ODE}{
    name=ODE,
    description={Ordinary Differential Equation, used in Continuous Normalizing Flows and Diffusion Models to define a continuous transformation process; numerical ODE solvers are used for transforming samples},
...
\newglossaryentry{SDE}{
    name=SDE,
    description={Stochastic Differential Equation, used in score-based generative modelling to describe the forward-process where noise is progressively added to data samples},
