...
In particle physics, jets are collimated streams of particles moving together in a cone-like structure.
A common feature in high-energy collisions, jets are emergent phenomena that arise due to the nature of QCD, particularly the property of colour confinement and asymptotic freedom.
If a high energy quark is emitted from a collision, it quickly radiates gluons which in turn either radiate more gluons or split into quark-antiquark pairs.
...
Jets are formed during the transition from the perturbative to the non-perturbative regimes of QCD and thus can be defined broadly, either as the collection of coloured partons, or as the collection of final colorless mesons and baryons\footnote{Jets are also sometimes defined as the captured energy shower in the detector.}.

Jet form primarily due to
