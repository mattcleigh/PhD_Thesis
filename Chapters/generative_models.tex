...
The objective is to predict the data itself, with the loss $\mathbb{E}_{\x, \e, t} \lambda(t) \left|\left| \x_\theta(\x_t, t) - \x\right|\right|^2$.
...
\begin{table}[h!]
    ...
    training target & noise - $\e$ & data - $\x$ & velocity - $(\x - \e)$ \\
