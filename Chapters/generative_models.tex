...
In HEP, NFs have been widely adopted for many tasks including unfolding, fast simulation, and template building, which are covered in detail in \Cref{ch:nuflows}, \Cref{ch:jet_generation}, and \Cref{ch:anomaly_detection} respectively.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/transformers/autoreg.pdf}
